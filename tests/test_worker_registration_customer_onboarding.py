...
def test_customer_onboarding_workflow_is_registered_on_iam_queue() -> None:
    ...
    workflow_names = {workflow_cls.__name__ for workflow_cls in workflows_map["user_lifecycle"]}
...
def test_customer_onboarding_activities_are_registered_on_iam_queue() -> None:
    ...
    activity_names = {activity_fn.__name__ for activity_fn in activities_map["user_lifecycle"]}
