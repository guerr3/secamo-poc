...
1. Validate workflow execution in Temporal (typically `CaseIntakeWorkflow` via ingress routing, or legacy direct SOC workflows when explicitly triggered), then confirm ticketing/notification/audit side effects.
