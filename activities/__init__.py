...
_SYMBOL_TO_MODULE = {
    ...
    "identity_dismiss_risky_user": "activities.identity",
    "identity_get_identity_risk": "activities.identity",
    "identity_get_user": "activities.identity",
    "identity_list_risky_users": "activities.identity",
    "identity_confirm_user_compromised": "activities.identity",
